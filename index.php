...
<html>
    <head>
        ...
        <title>Universo Matematicas</title>
    </head>
    <body>
                        ...
                        <table>
                            <tr>                                                                                                              
                                <td id="conjuntos">
                                    <table>
                                        <tr>
                                            <td colspan="2" rowspan="2" class="elemento" onclick="cargarScript('conjuntos');">
                                                <img onmouseover="clicksound.playclip();" src="Vista/imagenes/objetos/conjuntos.png" class="imagenUniverso" />
                                                <label class="textoUniverso">Conjuntos</label>   
                                            </td>
                                        </tr>
                                    </table>
                                </td>  
